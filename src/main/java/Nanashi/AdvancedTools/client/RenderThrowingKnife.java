...
public class RenderThrowingKnife extends Render<Entity_ThrowingKnife> {
    ...
    public void renderKnife(Entity_ThrowingKnife entity, double x, double y, double z, float entityYaw, float partialTick) {
        ...
        bufferBuilder.pos(-3.0D, -1.5D, -1.0D).tex((double) var16, (double) var18).endVertex();
        bufferBuilder.pos(-3.0D, -1.5D, 1.0D).tex((double) var17, (double) var18).endVertex();
        bufferBuilder.pos(-3.0D, 1.5D, 1.0D).tex((double) var17, (double) var19).endVertex();
        bufferBuilder.pos(-3.0D, 1.5D, -1.0D).tex((double) var16, (double) var19).endVertex();
        tessellator.draw();
        GL11.glNormal3f(0.0F, var20, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferBuilder.pos(-3.0D, -1.5D, -1.0D).tex((double) var16, (double) var18).endVertex();
        bufferBuilder.pos(-2.0D, -1.5D, -1.0D).tex((double) var17, (double) var18).endVertex();
        bufferBuilder.pos(-2.0D, -1.5D, 1.0D).tex((double) var17, (double) var19).endVertex();
        bufferBuilder.pos(-3.0D, -1.5D, 1.0D).tex((double) var16, (double) var19).endVertex();
        tessellator.draw();
        GL11.glNormal3f(0.0F, -var20, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        ...
        GL11.glNormal3f(-var20, 0.0F, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferBuilder.pos(-2.0D, 1.5D, -1.0D).tex((double) var16, (double) var18).endVertex();
        bufferBuilder.pos(-2.0D, 1.5D, 1.0D).tex((double) var17, (double) var18).endVertex();
        bufferBuilder.pos(-2.0D, -1.5D, 1.0D).tex((double) var17, (double) var19).endVertex();
        bufferBuilder.pos(-2.0D, -1.5D, -1.0D).tex((double) var16, (double) var19).endVertex();
        tessellator.draw();
        var18 += 0.25F;
        var19 += 0.25F;
        GL11.glNormal3f(var20, 0.0F, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferBuilder.pos(-5.0D, -0.5D, -0.5D).tex((double) var16, (double) var18).endVertex();
        bufferBuilder.pos(-5.0D, -0.5D, 0.5D).tex((double) var17, (double) var18).endVertex();
        bufferBuilder.pos(-5.0D, 0.5D, 0.5D).tex((double) var17, (double) var19).endVertex();
        bufferBuilder.pos(-5.0D, 0.5D, -0.5D).tex((double) var16, (double) var19).endVertex();
        tessellator.draw();
        GL11.glNormal3f(0.0F, var20, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferBuilder.pos(-5.0D, -0.5D, -0.5D).tex((double) var16, (double) var18).endVertex();
        bufferBuilder.pos(-3.0D, -0.5D, -0.5D).tex((double) var17, (double) var18).endVertex();
        bufferBuilder.pos(-3.0D, -0.5D, 0.5D).tex((double) var17, (double) var19).endVertex();
        bufferBuilder.pos(-5.0D, -0.5D, 0.5D).tex((double) var16, (double) var19).endVertex();
        tessellator.draw();
        GL11.glNormal3f(0.0F, -var20, 0.0F);
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        ...
        for (int var21 = 0; var21 < 2; ++var21) {
            ...
            GL11.glNormal3f(0.0F, 0.0F, var20);
            bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
            bufferBuilder.pos(-2.0D, -0.75D, 0.0D).tex((double) var12, (double) var14).endVertex();
            bufferBuilder.pos(3.0D, -0.75D, 0.0D).tex((double) var13, (double) var14).endVertex();
            bufferBuilder.pos(3.0D, 0.75D, 0.0D).tex((double) var13, (double) var15).endVertex();
            bufferBuilder.pos(-2.0D, 0.75D, 0.0D).tex((double) var12, (double) var15).endVertex();
            tessellator.draw();
        }
