...
//					this.altenativeMethodForAI();
    ...
    public void onUpdate() {
        if (!this.worldObj.isRemote) {
            ...
            if (this.frozen == null) {
                this.setDead();
            } else if (!this.frozen.isBurning() && this.FrozenRest > 0
                    && (this.frozen.hurtTime == 0 || this.FrozenRest >= 190)) {
                ...
                this.worldObj.playSoundAtEntity(this, "dig.glass"/*"random.glass"*/, 1.0F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
                this.setDead();
            }
        } else {
