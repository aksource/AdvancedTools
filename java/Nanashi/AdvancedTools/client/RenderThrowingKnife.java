...
public class RenderThrowingKnife extends Render
{
    ...
    public void renderKnife(Entity_ThrowingKnife entity, double x, double y, double z, float var8, float partialTick)
    {
        ...
        worldRenderer.pos(-3.0D, -1.5D, -1.0D).tex((double)var16, (double)var18).endVertex();
        worldRenderer.pos(-3.0D, -1.5D, 1.0D).tex((double)var17, (double)var18).endVertex();
        worldRenderer.pos(-3.0D, 1.5D, 1.0D).tex((double)var17, (double)var19).endVertex();
        worldRenderer.pos(-3.0D, 1.5D, -1.0D).tex((double)var16, (double)var19).endVertex();
        var10.draw();
        GL11.glNormal3f(0.0F, var20, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldRenderer.pos(-3.0D, -1.5D, -1.0D).tex((double)var16, (double)var18).endVertex();
        worldRenderer.pos(-2.0D, -1.5D, -1.0D).tex((double)var17, (double)var18).endVertex();
        worldRenderer.pos(-2.0D, -1.5D, 1.0D).tex((double)var17, (double)var19).endVertex();
        worldRenderer.pos(-3.0D, -1.5D, 1.0D).tex((double)var16, (double)var19).endVertex();
        var10.draw();
        GL11.glNormal3f(0.0F, -var20, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        ...
        GL11.glNormal3f(-var20, 0.0F, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldRenderer.pos(-2.0D, 1.5D, -1.0D).tex((double)var16, (double)var18).endVertex();
        worldRenderer.pos(-2.0D, 1.5D, 1.0D).tex((double)var17, (double)var18).endVertex();
        worldRenderer.pos(-2.0D, -1.5D, 1.0D).tex((double)var17, (double)var19).endVertex();
        worldRenderer.pos(-2.0D, -1.5D, -1.0D).tex((double)var16, (double)var19).endVertex();
        var10.draw();
        var18 += 0.25F;
        var19 += 0.25F;
        GL11.glNormal3f(var20, 0.0F, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldRenderer.pos(-5.0D, -0.5D, -0.5D).tex((double)var16, (double)var18).endVertex();
        worldRenderer.pos(-5.0D, -0.5D, 0.5D).tex((double)var17, (double)var18).endVertex();
        worldRenderer.pos(-5.0D, 0.5D, 0.5D).tex((double)var17, (double)var19).endVertex();
        worldRenderer.pos(-5.0D, 0.5D, -0.5D).tex((double)var16, (double)var19).endVertex();
        var10.draw();
        GL11.glNormal3f(0.0F, var20, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldRenderer.pos(-5.0D, -0.5D, -0.5D).tex((double)var16, (double)var18).endVertex();
        worldRenderer.pos(-3.0D, -0.5D, -0.5D).tex((double)var17, (double)var18).endVertex();
        worldRenderer.pos(-3.0D, -0.5D, 0.5D).tex((double)var17, (double)var19).endVertex();
        worldRenderer.pos(-5.0D, -0.5D, 0.5D).tex((double)var16, (double)var19).endVertex();
        var10.draw();
        GL11.glNormal3f(0.0F, -var20, 0.0F);
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        ...
        for (int var21 = 0; var21 < 2; ++var21)
        {
            ...
            GL11.glNormal3f(0.0F, 0.0F, var20);
            worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
            worldRenderer.pos(-2.0D, -0.75D, 0.0D).tex((double)var12, (double)var14).endVertex();
            worldRenderer.pos(3.0D, -0.75D, 0.0D).tex((double)var13, (double)var14).endVertex();
            worldRenderer.pos(3.0D, 0.75D, 0.0D).tex((double)var13, (double)var15).endVertex();
            worldRenderer.pos(-2.0D, 0.75D, 0.0D).tex((double)var12, (double)var15).endVertex();
            var10.draw();
        }
