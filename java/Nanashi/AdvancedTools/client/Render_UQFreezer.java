...
public class Render_UQFreezer extends Render<Entity_IHFrozenMob> {
    ...
    @Override
    public void doRender(@Nonnull Entity_IHFrozenMob var1, double var2, double var4, double var6, float var8, float var9) {
        ...
        GlStateManager.translate(0.0F, var1.height * 0.75F, 0.0F);//GL11.glTranslatef(0.0F, var1.height * 0.75F, 0.0F);
        GlStateManager.scale(var1.width * 1.5F, var1.height * 1.5F, var1.width * 1.5F);//GL11.glScalef(var1.width * 1.5F, var1.height * 1.5F, var1.width * 1.5F);
