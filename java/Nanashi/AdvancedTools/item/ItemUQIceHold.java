                        ...
                        for (var13 = -3; var13 <= 3; ++var13) {
                            for (int var25 = -3; var25 <= 3; ++var25) {
                                if (Math.sqrt((double) (var13 * var13 + var25 * var25)) <= 2.8D && var2.isAirBlock(var10 + var13, var11 + 1, var12 + var25)) {
                                    ...
                                    } else if (var2.getBlock(var10 + var13, var11 + 1, var12 + var25) == Blocks.air && Blocks.snow_layer.canPlaceBlockAt(var2, var10 + var13, var11 + 1, var12 + var25)) {
                                        var2.setBlock(var10 + var13, var11 + 1, var12 + var25, Blocks.snow_layer);
                                    }
                                }
                            }
                        }
